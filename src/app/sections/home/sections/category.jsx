      ...
      <div className="flex w-full">
        <ul className="flex flex-row gap-2 overflow-scroll pb-3">
          ...
          {dados_lanches.map((item) =>(
              <li kay={item.id} className="py-2 px-3 bg-orange-400 shadow-md shadow-orange-300 rounded-3xl flex flex-row item-center justify-center gap-2 cursor-pointer">
